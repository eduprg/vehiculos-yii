...
$id_uno = $_POST['Matricula']['idtipov'];
$lista = vehiculo::model()->findAll('idtipo = :id_uno',array(':id_uno' => $id_uno ));
$lista = CHtml::listData($lista,'id','placa_actual');
foreach ($lista as $valor => $placa_actual) {
	echo CHtml::tag('option',array('value' => $valor ), CHtml::encode($placa_actual), true ) ;
}
