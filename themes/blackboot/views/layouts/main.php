...
<body>
	<div class="navbar navbar-null navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				array('label'=>'Contacto','icon' => 'home', 'url'=>array('/site/contact')),
				array('label'=>'Usuario', 'url'=>array('/Usuario'), 'visible'=>!Yii::app()->user->isGuest),
				array('label'=>'Operador', 'url'=>array('/Operador'), 'visible'=>!Yii::app()->user->isGuest),
				array('label'=>'Supervisor', 'url'=>array('/Supervisor'), 'visible'=>!Yii::app()->user->isGuest),
				array('label'=>'Obra', 'url'=>array('/Obra'), 'visible'=>!Yii::app()->user->isGuest ),
				array('label'=>'Reparto', 'url'=>array('/Reparto'), 'visible'=>!Yii::app()->user->isGuest ),
				array('label'=>'Faltas', 'url'=>array('/Registro'), 'visible'=>!Yii::app()->user->isGuest ),
